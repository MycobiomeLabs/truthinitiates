...
[
    ...
    items.push(new (0, _item.Item)(item));
});
// Toggle grid view
const switchCtrl = {
...
const animateOnScroll = ()=>{
    for (const item of items){
        ...
        }).addLabel("start", 0)// scale up the inner image
        .to(item.DOM.imageInner, {
            ease: "none",
            scaleY: 2.4,
            scaleX: 1.2,
            opacity: 0
        }, "start")// translate the title and number
        .to([
            item.DOM.title,
            item.DOM.number
        ], {
            ease: "none",
            yPercent: -150
        }, "start")// translate the inner title/number (overflow is hidden so they get hidden)
        .to([
            item.DOM.titleInner,
...
const showGrid = ()=>{
    ...
    let Alltrigger = (0, _scrollTrigger.ScrollTrigger).getAll();
    for(let i = 0; i < Alltrigger.length; i++)Alltrigger[i].disable(false);
    // Use gsap flip for the animation
    // save the current state of the images
    const flipstate = (0, _flip.Flip).getState(DOM.allImages);
    ...
    .to(DOM.inViewportImagesInner, {
        ...
        opacity: 1,
        stagger: staggerConfig
    }, 0)// For the items outside of the viewport, simply reset the scales with no animation
    .set(DOM.outViewportImagesInner, {
        scaleX: 1,
        scaleY: 1,
        opacity: 1
    }, 0)// hide the titles and numbers inner elments by translating them up
    .to([
    ...
    .to(DOM.inViewportDescription, {
        ...
        ease: "power3.inOut",
        opacity: 0
    }, 0)// For all the items outside the viewport, simply set opacity to 0
    .set([
...
const hideGrid = ()=>{
    ...
    // get the DOM elements that we'll work with
    const DOM = getDOMElements();
    const flipstate = (0, _flip.Flip).getState([
        DOM.allImages,
        DOM.allImagesInner
    ], {
        props: "opacity"
    ...
    let Alltrigger = (0, _scrollTrigger.ScrollTrigger).getAll();
    for(let i = 0; i < Alltrigger.length; i++)Alltrigger[i].enable(false);
    (0, _flip.Flip).from(flipstate, {
        duration: 0.7,
        ease: "power3.inOut",
        scale: true
...
const getDOMElements = ()=>{
    const inViewportItems = items.filter((item)=>(0, _utils.isInViewport)(item.DOM.el));
...
// Preload images
(0, _utils.preloadImages)(".item__image-inner").then(()=>{
...
},{"./utils":"72Dku","./item":"8aqVM","@studio-freight/lenis":"ggVJc","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","gsap/Flip":"iKp6p","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"72Dku":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"8aqVM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ggVJc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var l = [
    ...
    var e, r;
    function l(e) {
        var o, r, n, s, l = void 0 === e ? {} : e, a = l.duration, h = void 0 === a ? 1.2 : a, p = l.easing, u = void 0 === p ? function(t) {
            return Math.min(1, 1.001 - Math.pow(2, -10 * t));
        } : p, d = l.smooth, f = void 0 === d || d, v = l.smoothTouch, g = void 0 !== v && v, w = l.touchMultiplier, m = void 0 === w ? 2 : w, y = l.direction, b = void 0 === y ? "vertical" : y, S = l.gestureDirection, N = void 0 === S ? "vertical" : S, O = l.infinite, z = void 0 !== O && O, R = l.wrapper, W = void 0 === R ? window : R, T = l.content, M = void 0 === T ? document.body : T;
        (s = t.call(this) || this).onWindowResize = function() {
            ...
            var i = t.deltaY, e = t.deltaX, o = t.originalEvent;
            o.ctrlKey || (s.smooth = o.changedTouches ? s.smoothTouch : s.options.smooth, s.stopped ? o.preventDefault() : s.smooth && 4 !== o.buttons && (s.smooth && o.preventDefault(), s.targetScroll -= "both" === s.gestureDirection ? e + i : "horizontal" === s.gestureDirection ? e : i, s.scrollTo(s.targetScroll)));
        }, s.onScroll = function(t) {
            s.isScrolling && s.smooth || (s.targetScroll = s.scroll = s.lastScroll = s.wrapperNode[s.scrollProperty], s.notify());
        }, window.lenisVersion = "0.2.13", s.options = {
            duration: h,
            easing: u,
            smooth: f,
            smoothTouch: g,
    ...
    return a.start = function() {
        ...
        if (null != t) {
            ...
            p += r, this.targetScroll = this.infinite ? p : Math.max(0, Math.min(p, this.limit)), !this.smooth || s ? this.setScroll(this.targetScroll) : this.animate.to(this, {
                duration: c,
                easing: h,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire2011")
